...
class OfficeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $offices = [
            ...
            ['name' => 'First Technology Development Pte Ltd.', 'office_type_id' => $branchOffice->id, 'address' => '1st North Bridge Road#19-09, High Street Center, Singapore-179094', 'phone' => '+88 02222299837', 'email' => 'carrierservice@ftdlsg.com', 'logo' => 'images/ftdllogo.png', 'order_number' => 5],
        ];
