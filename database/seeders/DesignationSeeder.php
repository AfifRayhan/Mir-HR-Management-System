...
class DesignationSeeder extends Seeder
{
    public function run(): void
    {
        $designations = [
            ...
            ['name' => 'Assistant Engineer',     'short_name' => 'AE',   'priority' => 6],
            ['name' => 'Assistant Manager',      'short_name' => 'AM',   'priority' => 5],
            ['name' => 'Asst. Pastry Chef',      'short_name' => 'APC',  'priority' => 6],
            ['name' => 'Barista',                'short_name' => 'BAR',  'priority' => 7],
            ...
            ['name' => 'SOUS CHEF',              'short_name' => 'SC',   'priority' => 5],
            ...
            ['name' => 'Sr. Software Engineer',  'short_name' => 'SSE',  'priority' => 4],
            ['name' => 'Sr. System Engineer',    'short_name' => 'SSY',  'priority' => 4],
            ...
            ['name' => 'Supervisor',             'short_name' => 'SUP',  'priority' => 5],
