        ...
        <main class="hr-main">
            ...
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1">{{ __('Office Type Management') }}</h5>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="hr-panel">
                        ...
                        <form action="{{ route('settings.office-types.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label small fw-bold text-muted">{{ __('Type Name') }} <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control rounded-3" placeholder="{{ __('e.g. Corporate Head Office') }}" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" class="form-control rounded-3" rows="3" placeholder="{{ __('Optional description...') }}"></textarea>
                            </div>

                            <button type="submit" class="btn btn-primary w-100 py-2 rounded-pill shadow-sm">
                                <i class="bi bi-plus-circle me-2"></i>{{ __('Save Type') }}
                            </button>
                        </form>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('settings.office-types.destroy', $type) }}" method="POST" data-confirm data-confirm-message="{{ $statement }}">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content rounded-4 border-0 shadow">
                                                <div class="modal-header border-0 pb-0">
                                                    <h5 class="modal-title fw-bold text-primary">{{ __('Edit Office Type') }}</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form action="{{ route('settings.office-types.update', $type) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body py-4">
                                                        <div class="mb-3">
                                                            <label class="form-label small fw-bold text-muted">{{ __('Type Name') }}</label>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="order_number" class="form-control rounded-3" value="{{ $type->order_number }}" required>
                                                        </div>
                                                        <div class="mb-0">
                                                            <label class="form-label small fw-bold text-muted">{{ __('Description') }}</label>
