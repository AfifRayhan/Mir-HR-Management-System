                        ...
                        <form action="{{ route('settings.office-times.store') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="remarks" class="form-control rounded-3" rows="2" maxlength="100" placeholder="{{ __('Optional remarks (max 100 characters)') }}">{{ old('remarks') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mt-5 border-top pt-4 d-flex justify-content-between">
                                ...
                                <button type="submit" id="submit_btn" class="btn btn-primary px-5 rounded-pill shadow-sm">
