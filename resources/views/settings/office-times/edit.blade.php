                        ...
                        <form action="{{ route('settings.office-times.update', $officeTime) }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="start_time" name="start_time" class="form-control rounded-3 @error('start_time') is-invalid @enderror" value="{{ old('start_time', substr($officeTime->start_time, 0, 5)) }}" placeholder="Select start time" readonly required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="end_time" name="end_time" class="form-control rounded-3 @error('end_time') is-invalid @enderror" value="{{ old('end_time', substr($officeTime->end_time, 0, 5)) }}" placeholder="Select end time" readonly required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="late_after" name="late_after" class="form-control rounded-3 @error('late_after') is-invalid @enderror" value="{{ old('late_after', $officeTime->late_after ? substr($officeTime->late_after, 0, 5) : '') }}" placeholder="Select time (optional)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="absent_after" name="absent_after" class="form-control rounded-3 @error('absent_after') is-invalid @enderror" value="{{ old('absent_after', $officeTime->absent_after ? substr($officeTime->absent_after, 0, 5) : '') }}" placeholder="Select time (optional)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="lunch_start" name="lunch_start" class="form-control rounded-3 @error('lunch_start') is-invalid @enderror" value="{{ old('lunch_start', $officeTime->lunch_start ? substr($officeTime->lunch_start, 0, 5) : '') }}" placeholder="Select time (optional)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="lunch_end" name="lunch_end" class="form-control rounded-3 @error('lunch_end') is-invalid @enderror" value="{{ old('lunch_end', $officeTime->lunch_end ? substr($officeTime->lunch_end, 0, 5) : '') }}" placeholder="Select time (optional)">
