        ...
        <main class="hr-main">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <h4 class="fw-bold mb-1">{{ __('Create Notice/Event') }}</h4>
                    <p class="text-muted mb-0 small">{{ __('Publish a new announcement or event for all employees') }}</p>
                </div>
            </div>
            ...
            <div class="hr-panel shadow-sm">
                <form action="{{ route('settings.notices.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="content" rows="6" class="form-control rounded-3 @error('content') is-invalid @enderror" placeholder="Write notice content here..." required>{{ old('content') }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch p-3 bg-light rounded-3">
                                    <input class="form-check-input ms-0 me-3" type="checkbox" name="is_active" role="switch" id="isActiveSwitch" checked>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4 pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4">{{ __('Publish Notice') }}</button>
                    </div>
                </form>
            </div>
        </main>
