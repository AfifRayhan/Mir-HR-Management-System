<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Attendance Adjustments Approvals') }}
        </h2>
    </x-slot>
    ...
    <div class="hr-layout">
        ...
        <main class="hr-main">
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-12">
                        <h4 class="mb-0">{{ __('Pending Attendance Adjustments') }}</h4>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="d-flex justify-content-end gap-2">
                                                <form action="{{ route('personnel.attendances.approve-adjustment', $adjustment->id) }}" method="POST"
                                                    data-confirm
                                            ...
                                            <div class="modal fade text-start" id="rejectModal{{ $adjustment->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <form class="modal-content border-0 shadow" action="{{ route('personnel.attendances.reject-adjustment', $adjustment->id) }}" method="POST">
                                                        @csrf
