            ...
            <div class="ui-download-bar d-flex justify-content-end align-items-center no-print">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center py-2" target="_blank" href="{{ route('personnel.reports.attendances.monthly.export.pdf', array_merge(request()->all(), ['action' => 'print'])) }}">
