                        ...
                        <div class="mt-4 d-flex justify-content-end gap-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0">
                                    ...
                                    <li><a class="dropdown-item py-2" target="_blank" href="{{ route('overtimes.export', ['employee_id' => $selectedEmployee->id, 'month' => $month, 'year' => $year, 'format' => 'pdf', 'action' => 'print']) }}"><i class="bi bi-printer text-info me-2"></i> Print PDF</a></li>
