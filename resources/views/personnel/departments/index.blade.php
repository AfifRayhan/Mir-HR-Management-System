                            ...
                            <table class="ui-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="hr-badge ui-badge-global">{{ $department->short_name ?: '---' }}</span></td>
                                        <td>
                                        ...
                                        <td class="text-end pe-4">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('personnel.departments.destroy', $department) }}" method="POST" data-confirm data-confirm-message="{{ $confirmMsg }}">
                                                    @csrf
                                                    @method('DELETE')
