<x-app-layout>
    ...
    <div class="ui-layout">
        ...
        <main class="ui-main">
            <div class="row mb-4">
                <div class="col-12">
                    <h5 class="mb-1 fw-bold">{{ __('Employee Leave History') }}</h5>
                    <p class="mb-0 text-muted">{{ __('View and filter all employee leave applications') }}</p>
                </div>
            </div>

            <div class="ui-panel p-0 overflow-hidden mb-4">
                <div class="border-bottom p-4 bg-light">
                    <form action="{{ route('personnel.leave-applications.history') }}" method="GET">
                        <div class="row g-3">
                            <div class="col-md-11">
                                <div class="row g-2">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        <div class="d-flex gap-2 w-100">
                                            ...
                                            <a href="{{ route('personnel.leave-applications.history') }}" class="btn btn-outline-secondary btn-sm rounded-3" title="Clear">
                    ...
                    <table class="table ui-table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($app->approver)
                                    <div class="small fw-bold text-gray-800">{{ $app->approver->name ?: __('Approver') }}</div>
